...
<p>
  ...
  <img src="https://img.shields.io/badge/GSAP-3.12.5-88CE02?style=flat&logoColor=white" alt="GSAP" />
  <img src="https://img.shields.io/badge/Responsive-Web-2F6BFF?style=flat" alt="Responsive Web" />
  <img src="https://img.shields.io/badge/AI-Vibe%20Coding-FFBE2E?style=flat" alt="AI Vibe Coding" />
...
| 프로젝트 | 문제 | 해결 방향 | 결과 |
|---|---|---|---|
| 모여라 | 낯선 모임의 진입 장벽 | 친근한 시스템과 모바일 우선 UI | 배포 가능한 반응형 모임 경험 |
| ViewLight | 조명 변화의 감각적 차이를 비교하기 어려움 | Before/After 조도 비교와 AI 큐레이션 | 직관적인 이커머스 웹 체험 |
| KARI | 우주과학 전문 정보의 높은 이해 장벽 | Canvas·TTS·접근성 기반 인터랙션 | 몰입형 우주 학습 경험 |
...
```mermaid
flowchart TD
    A["포트폴리오 접속"] --> B["Hero 핵심 메시지 확인"]
    B --> C["About에서 작업 방식 이해"]
    C --> D["Experience 커리어 타임라인"]
    D --> E["Selected Projects 탐색"]

    E --> E1["모여라"]
    E --> E2["ViewLight"]
    E --> E3["KARI"]
    E --> E4["뭉치"]
    E1 --> F["Case Study·Live 페이지 이동"]
    E2 --> F
    E3 --> F
    E4 --> F

    E --> G["Design System 확인"]
    G --> H["MIO AI Creative Lab"]
    H --> I["문제 해결 사례 확인"]
    I --> J{"연락·채널 선택"}
    J -->|"이메일 버튼"| K["메일 작성"]
    J -->|"QR·카드"| L["Instagram·Notion·GitHub"]
```
